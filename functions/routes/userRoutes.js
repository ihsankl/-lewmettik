...
router.put('/:id', _userValidator.findUser, _userValidator.userValidator, userController.update);
/**
 * DELETE /api/users/:id.
 */

router.delete('/:id', _userValidator.findUser, userController.deleteUser);
var _default = router;
